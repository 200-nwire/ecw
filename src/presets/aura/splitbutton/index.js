  ...
  button: {
    root: ({ parent }) => ({
      class: [
        ...
        // Plain Button
        {
          'text-white bg-grey-500 border border-grey-500':
            parent.props.plain && !parent.props.outlined && !parent.props.text,
        },
        // Plain Text Button
        { 'text-surface-500': parent.props.plain && parent.props.text },
        // Plain Outlined Button
        { 'text-surface-500 border border-grey-500': parent.props.plain && parent.props.outlined },
        ...
        // Plain
        {
          'hover:bg-grey-600 hover:border-grey-600': parent.props.plain && !parent.props.outlined && !parent.props.text,
        },
