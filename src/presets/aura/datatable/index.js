export default {
  ...
  table: {
    class: 'w-full h-full border-spacing-0 border-separate',
  },
  thead: ({ context }) => ({
    class: [
      {
        'bg-base-white top-0 z-40 sticky': context.scrollable,
      },
    ],
  }),
  ...
  footer: {
    class: [
      ...
      // Shape
      // 'border-b-0 border-t border-x-0 border-t-[2px]',

      // Spacing
      'p-2',

      // Color
      // 'border-neutral-level-2',
      'text-primary',
    ],
  },
  column: {
    headercell: ({ context, props }) => ({
      class: [
        ...
        // Position
        { 'sticky z-20 border-b right-0 shadow-sm-left lg:shadow-none': props.frozen || props.frozen === '' },
        ...
        // Shape
        'border-0 border-b border-solid border-b-[2px]',
    ...
    bodycell: ({ props, context, state, parent }) => ({
      class: [
        ...
        {
          'sticky box-border border-b z-20 right-0 shadow-sm-left lg:shadow-none': props.frozen || props.frozen === '',
        },
        ...
        // Shape
        'border-0 border-t border-solid border-t-[2px]',
        { 'bg-base-white lg:bg-transparent': parent.instance.frozenRow || props.frozen || props.frozen === '' },
    ...
    filteroperatordropdown: {
      ...
      panel: {
        class: [
          // Colors
          'bg-base-white dark:bg-surface-900',
          'text-surface-700 dark:text-white/80',
  ...
  bodyrow: ({ context, props }) => ({
    class: [
      ...
      { 'bg-base-white text-primary': !context.selected },
      { 'font-bold bg-base-white z-20': props.frozenRow },
      {
  ...
  rowgroupheader: {
    class: ['sticky z-20', 'bg-neutral-level-1'],
  },
  rowgroupfooter: {
    class: ['sticky z-20', 'bg-neutral-level-1'],
  },
