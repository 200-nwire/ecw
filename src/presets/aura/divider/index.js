export default {
  root: ({ props }) => ({
    class: [
      ...
      // Spacing
      {
        'my-5 py-0 px-5': props.layout == 'horizontal',
        'mx-[3px] my-2': props.layout == 'vertical',
      },
      ...
      {
        'w-1 bg-neutral-150': props.layout == 'vertical',
        'h-[1px] bg-neutral-150': props.layout == 'horizontal',
      },
